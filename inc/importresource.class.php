...
class PluginResourcesImportResource extends CommonDBTM {
   ...
   function delete(array $input, $force = 0, $history = 1) {
      ...
      $dataCrit = self::$keyInOtherTables . " = " . $input[self::getIndexName()];
   ...
   function updateDatas($datas, $importResourceID) {
      ...
      $crit = PluginResourcesImportResourceData::$items_id . " = " . $importResourceID;
   ...
   function checkHeader($header) {
      ...
      foreach ($imports as $import) {
         ...
         $crit = PluginResourcesImport::$keyInOtherTables . " = " . $import['id'];
