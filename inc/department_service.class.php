...
**/
class PluginResourcesDepartment_Service extends CommonDBRelation{

   // From CommonDBRelation
   static public $itemtype_1   = 'PluginResourcesDepartment';
   static public $items_id_1   = 'plugin_resources_departments_id';
