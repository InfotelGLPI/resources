...
*
**/
class PluginResourcesRuleContracttypeHidden extends Rule {
   ...
   function getTitle() {
      ...
      return PluginResourcesResource::getTypeName(2)." ".__('Hidden Fields', 'resources');
   }
   ...
   **/
   ...
   function getActions() {
      ...
      $actions['hiddenfields_plugin_resources_departments_id']['name']  = PluginResourcesDepartment::getTypeName(1);
