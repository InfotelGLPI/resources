...
/**
 * Class PluginResourcesRuleContracttypeReadonlyCollection
 */
class PluginResourcesRuleContracttypeReadonlyCollection extends RuleCollection {

    static $rightname = 'plugin_resources';

    // From RuleCollection
    public $stop_on_first_match=true;
    public $menu_option='resources';
