...
CREATE TABLE `glpi_plugin_resources_configs` (
   ...
   `creat_ticket_departure` tinyint(1) NOT NULL default '0',
...
CREATE TABLE `glpi_plugin_resources_linkmetademands` (
   ...
   `checklist_in` varchar(255) collate utf8_unicode_ci default NULL,
   `checklist_out` varchar(255) collate utf8_unicode_ci default NULL,
   PRIMARY KEY  (`id`),
...
CREATE TABLE `glpi_plugin_resources_adconfigs` (
   ...
   `creation_categories_id` int(11) NOT NULL default '0',
   `modification_categories_id` int(11) NOT NULL default '0',
   `deletion_categories_id` int(11) NOT NULL default '0',
