...
ALTER TABLE glpi_plugin_resources_resources
    ADD `plugin_resources_accessprofiles_id` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_resources_accessprofiles (id)';
ALTER TABLE glpi_plugin_resources_resources
    ADD `users_id_sales` int(11) NOT NULL default '0' COMMENT 'RELATION to glpi_users (id)';
ALTER TABLE glpi_plugin_resources_resources
    ADD `date_declaration_leaving` datetime default NULL;
