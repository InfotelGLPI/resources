ALTER TABLE `glpi_plugin_resources_departments`
    ADD `plugin_resources_employers_id` INT(11) NULL DEFAULT '0' AFTER `entities_id`;
...
ALTER TABLE `glpi_plugin_resources_configs`
    ADD `create_ticket_departure` tinyint(1) NOT NULL default '0' AFTER `sales_manager`;
ALTER TABLE `glpi_plugin_resources_configs`
    ADD `categories_id` INT(11) NULL DEFAULT '0' AFTER `create_ticket_departure`;

ALTER TABLE `glpi_plugin_resources_checklistconfigs`
    ADD `itemtype` VARCHAR(255) NOT NULL DEFAULT '' AFTER `comment`;
ALTER TABLE `glpi_plugin_resources_checklistconfigs`
    ADD `items` int(11) NOT NULL default '0' AFTER `itemtype`;
