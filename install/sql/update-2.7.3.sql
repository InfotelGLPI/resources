ALTER TABLE `glpi_plugin_resources_resources`
    ADD `plugin_resources_functions_id` int unsigned NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_resources_functions (id)';
ALTER TABLE `glpi_plugin_resources_resources`
    ADD `plugin_resources_teams_id` int unsigned NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_resources_teams (id)';
ALTER TABLE `glpi_plugin_resources_resources`
    ADD `plugin_resources_services_id` int unsigned NOT NULL default '0' COMMENT 'RELATION to glpi_plugin_resources_services (id)';
ALTER TABLE `glpi_plugin_resources_resources`
    ADD `matricule_second` varchar(255) NOT NULL default '';
...
ALTER TABLE `glpi_plugin_resources_linkads`
    ADD `service` varchar(255) NOT NULL default '';
ALTER TABLE `glpi_plugin_resources_linkads`
    ADD `location` varchar(255) NOT NULL default '';
ALTER TABLE `glpi_plugin_resources_adconfigs`
    ADD `serviceAD` varchar(255) NOT NULL default '';
ALTER TABLE `glpi_plugin_resources_adconfigs`
    ADD `locationAD` varchar(255) NOT NULL default '';

ALTER TABLE `glpi_plugin_resources_linkmetademands`
    ADD `habilitation` TEXT collate utf8_unicode_ci default NULL;
ALTER TABLE `glpi_plugin_resources_linkmetademands`
    ADD `is_leaving_resource` tinyint(1) NOT NULL default '0';
...
ALTER TABLE `glpi_plugin_resources_resources`
    ADD `secondary_services` varchar(255) NOT NULL default '';
ALTER TABLE `glpi_plugin_resources_resources`
    ADD `gender` varchar(3) NOT NULL default '';
