...
CREATE TABLE `glpi_plugin_resources_resources` (
   ...
   `matricule_SYGES` varchar(255) NOT NULL default '0',
   `id_SYGES` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
   `branching_agency_SYGES` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
   `contracttype_SYGES` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
   `email_SYGES` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
   PRIMARY KEY  (`id`),
   KEY `name` (`name`),
...
CREATE TABLE `glpi_plugin_resources_imports` (
   ...
   `users_id_sales`  varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
   `date_begin` date default NULL,
   `date_end` date default NULL,
