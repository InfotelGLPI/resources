...
xgettext *.php */*.php */*/*.php --copyright-holder='Resources Development Team' --package-name='GLPI - Resources plugin' --package-version='3.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
