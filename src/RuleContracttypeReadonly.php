...
class RuleContracttypeReadonly extends Rule {
    ...
    function getActions() {
        ...
        $actions['readonlyfields_plugin_resources_departments_id']['name']  = Department::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_employers_id']['name']  = Employer::getTypeName();
        ...
        if (Session::haveRight('plugin_resources_dropdown_public', UPDATE)) {
            ...
            $actions['readonlyfields_plugin_resources_ranks_id']['name']  = Rank::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_contractnatures_id']['name']  =  ContractNature::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_resourcespecialities_id']['name']  = ResourceSpeciality::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_services_id']['name']  = Service::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_teams_id']['name']  = Team::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_functions_id']['name']  = ResourceFunction::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_degreegroups_id']['name']  = DegreeGroup::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_recruitingsources_id']['name']  = RecruitingSource::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_workprofiles_id']['name']  = WorkProfile::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_clients_id']['name']  = Client::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_destinations_id']['name']  = Destination::getTypeName(1);
        ...
        $actions['readonlyfields_plugin_resources_leavingreasons_id']['name']  = LeavingReason::getTypeName(1);
