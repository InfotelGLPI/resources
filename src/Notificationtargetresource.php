...
/**
 * Class NotificationTargetResource
 */
class NotificationTargetResource extends NotificationTarget
{
    public const RESOURCE_MANAGER = 4300;
    public const RESOURCE_AUTHOR = 4301;
    public const RESOURCE_AUTHOR_LEAVING = 4302;
    public const RESOURCE_TASK_TECHNICIAN = 4303;
    public const RESOURCE_TASK_GROUP = 4304;
    public const RESOURCE_USER = 4305;
    public const RESOURCE_TARGET_ENTITY_GROUP = 4306;
    public const RESOURCE_SOURCE_ENTITY_GROUP = 4307;
    public const RESOURCE_SOURCE_ENTITY_GROUP_MANAGER = 4308;
    ...
    {
        return [
            'new' => __('A resource has been added by', 'resources'),
     ...
     */
    public function getEntityGroup($options, $type = 'source', $supervisor = false)
    {
        global $DB;
        ...
        $criteria['LEFT JOIN'] = [
            ...
            TransferEntity::getTable() => [
                'ON' => [
                    TransferEntity::getTable() => 'groups_id',
    ...
    public function getSalesManagerAddress()
    {
    ...
    public function getAuthorLeavingAddress()
    {
     ...
     * @param array $options
     */
    public function getRessourceAddress($options = [])
    {
        global $DB;
     ...
     * @param array $options
     */
    public function getTaskTechAddress($options = [])
    {
        global $DB;
     ...
     * @param array $options
     */
    public function getTaskGroupAddress($options = [])
    {
        global $DB;
    ...
    public function addDataForTemplate($event, $options = [])
    {
        ...
        if ($event == 'AlertExpiredTasks') {
            ...
            $this->data['##lang.checklist.type##'] = ContractType::getTypeName(1);
            ...
            $this->data['##lang.checklist.department##'] = Department::getTypeName(1);
            $this->data['##lang.checklist.habilitation##'] = Habilitation::getTypeName(1);
            $this->data['##lang.checklist.status##'] = ResourceState::getTypeName(1);
            ...
            //         $this->data['##lang.checklist.leavingreason##'] = LeavingReason::getTypeName(1);
            ...
            $this->data['##lang.resource.users##'] = __('Resource manager', 'resources');
            $this->data['##resource.users##'] = getUserName($this->obj->getField("users_id"));

            $this->data['##lang.resource.userssale##'] = __('Sales manager', 'resources');
            $this->data['##resource.userssale##'] = getUserName($this->obj->getField("users_id_sales"));

            $this->data['##lang.resource.usersrecipient##'] = __('Requester');
            $this->data['##resource.usersrecipient##'] = getUserName($this->obj->getField("users_id_recipient"));
        ...
        } elseif ($event == 'AlertCommercialManager') {
            ...
            if ($event == 'newresting'
                ...
                $this->data['##lang.resource.restingtitle##'] = _n(
                ...
                $ResourceResting = new ResourceResting();
                $ResourceResting->getFromDB($options['resting_id']);
                ...
                $this->data['##resource.home##'] = Dropdown::getYesNo($ResourceResting->fields['at_home']);

                $this->data['##lang.resource.datebegin##'] = __('Begin date');
                $this->data['##resource.datebegin##'] = Html::convDate($ResourceResting->fields['date_begin']);

                $this->data['##lang.resource.dateend##'] = __('End date');
                $this->data['##resource.dateend##'] = Html::convDate($ResourceResting->fields['date_end']);
            ...
            if ($event == 'newholiday'
                ...
                $ResourceHoliday = new ResourceHoliday();
                $ResourceHoliday->getFromDB($options['holiday_id']);

                $this->data['##lang.resource.datebegin##'] = __('Begin date');
                $this->data['##resource.datebegin##'] = Html::convDate($ResourceHoliday->fields['date_begin']);

                $this->data['##lang.resource.dateend##'] = __('End date');
                $this->data['##resource.dateend##'] = Html::convDate($ResourceHoliday->fields['date_end']);
            ...
            if (isset($this->target_object->oldvalues)
                ...
                if (isset($this->target_object->oldvalues['users_id'])) {
                    if (empty($this->target_object->oldvalues['users_id'])) {
                        ...
                        $tmp['##update.users##'] = getUserName($this->target_object->oldvalues['users_id']);
                    }
                }
                ...
                if (isset($this->target_object->oldvalues['users_id_sales'])) {
                    if (empty($this->target_object->oldvalues['users_id_sales'])) {
                        ...
                        $tmp['##update.userssale##'] = getUserName($this->target_object->oldvalues['users_id_sales']);
                    }
                }
            ...
            } elseif (isset($options['tasks_id']) && $options['tasks_id']) {
                $restrict += ["id" => $options['tasks_id']];
            }
    ...
    public function getTags()
    {
        $tags = [
            ...
            'resource.type' => ContractType::getTypeName(1),
            'resource.quota' => __('Quota', 'resources'),
            'resource.situation' => ResourceSituation::getTypeName(1),
            'resource.contractnature' => ContractNature::getTypeName(1),
            'resource.rank' => Rank::getTypeName(1),
            'resource.speciality' => ResourceSpeciality::getTypeName(1),
            ...
            'resource.leavingreason' => LeavingReason::getTypeName(1),
            ...
            'update.type' => ContractType::getTypeName(1),
            'update.quota' => __('Quota', 'resources'),
            'update.situation' => ResourceSituation::getTypeName(1),
            'update.contractnature' => ContractNature::getTypeName(1),
            'update.rank' => Rank::getTypeName(1),
            'update.speciality' => ResourceSpeciality::getTypeName(1),
            ...
            'update.department' => Department::getTypeName(1),
            'update.status' => ResourceState::getTypeName(1),
            ...
            'update.leavingreason' => LeavingReason::getTypeName(1),
   ...
   &lt;/span&gt;&lt;/p&gt;';
    ...
    public static function update80()
    {
        global $DB;
...
##ENDFOREACHupdates##';
    ...
    public static function update203()
    {
        global $DB;
...
&lt;/table&gt;';
    ...
    public static function update204()
    {
        global $DB;
...
&lt;p&gt;La ressource ##resource.firstname## ##resource.name## a été transférée de l\'entité ##resource.sourceentity## vers l\'entité ##resource.targetentity##.&lt;/p&gt;";
    ...
    public static function update231()
    {
        global $DB;
...
&lt;/table&gt;';
    ...
    public static function update_notif()
    {
        global $DB;
...
##IFresource.informations####lang.resource.informations## : ##resource.informations####ENDIFresource.informations##';
     ...
     * @return string
     */
    public static function getContentTextResource()
    {
   ...
   ##ENDIFtask.realtime## ----------##ENDFOREACHtasks## ';
     ...
     * @return string
     */
    public static function getContentHtmlResource()
    {
     ...
     * @return string
     */
    public static function getContentHtmlResourceReport()
    {
...
&lt;/table&gt;';
     ...
     * @return string
     */
    public static function getContentHtmlResourceResting()
    {
...
&lt;p&gt;##ENDFOREACHupdates##&lt;/p&gt;';
     ...
     * @return string
     */
    public static function getContentHtmlResourceHoliday()
    {
