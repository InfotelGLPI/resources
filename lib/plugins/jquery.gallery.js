    ...
    $.widget("ui.gallery", {
        ...
        generatePages: function () {
            ...
            var gallery = this,
                ...
                pages = {
                    item: $('<ul id="work-gallery-pages" style="visibility:hidden;"></ul>'),
                    count: Math.ceil(images.count / 8)
                },
            ...
            for (var index = 1; index <= pages.count; index++) {
                ...
                $('<li><a href="/work/page/' + index + '">' + index + '</a></li>').find('a').click(function () {
                    ...
                    if (!galleryPageAnimating) {
                        ...
                        $('#work-gallery').animate({marginTop: (214 * (parseInt($(this).text()) - 1)) * -1}, 500, 'easeOutExpo', function () {
                            galleryPageAnimating = false;
                        });
