...
function plugin_resources_install()
{
   ...
   ADD `comment` text collate utf8_unicode_ci;";
    ...
    if (!$DB->fieldExists("glpi_plugin_resources_adconfigs", "tls_allow_invalid_cert")) {
        $DB->runFile(PLUGIN_RESOURCES_DIR . "/install/sql/update-4.1.2.sql");
    }
...
function plugin_resources_getDropdown()
{
    if (Plugin::isPluginActive("resources")) {
        return [
            ...
            ResourceState::class => ResourceState::getTypeName(2),
