...
$report_target = PLUGIN_RESOURCES_WEBDIR . '/report/professionwithoutcost/professionwithoutcost.php';
...
if ($report->criteriasValidated()) {
    ...
    $budgetIterator = $DB->request([
        'SELECT'   => 'plugin_resources_professions_id',
        'DISTINCT' => true,
    ...
    foreach ($budgetIterator as $data) {
    ...
    $criteria = [
                ...
                'ON' => [
                    ...
                    [
                        ...
                        'AND' => [
                            [
                                'OR' => [
                                    ['glpi_plugin_resources_costs.begin_date' => null],
                                    [
                                        'AND' => [
                                            ['glpi_plugin_resources_costs.begin_date' => ['<', $date]],
                                            ['glpi_plugin_resources_costs.end_date' => null],
                                        ],
                                    ],
                                    ['glpi_plugin_resources_costs.end_date' => ['>', $date]],
                                ],
                            ],
                        ],
                    ],
        ...
        'WHERE'     => [
            'glpi_plugin_resources_professions.id'        => $professionsBudgetList,
            ...
            [
                'OR' => [
                    ['glpi_plugin_resources_costs.id' => null],
                    [
                        'NOT'                                    => ['glpi_plugin_resources_costs.begin_date' => null],
                        'glpi_plugin_resources_costs.begin_date' => ['>', $date],
                    ],
                    [
                        'NOT'                                  => ['glpi_plugin_resources_costs.end_date' => null],
                        'glpi_plugin_resources_costs.end_date' => ['<', $date],
                    ],
                ],
            ],
    ...
    $rankIterator = $DB->request([
        'SELECT'   => 'glpi_plugin_resources_costs.plugin_resources_ranks_id',
        'DISTINCT' => true,
        ...
        'ORDERBY'  => 'glpi_plugin_resources_costs.plugin_resources_ranks_id',
    ]);
...
function showTitle($output_type, &$num, $title, $columnname, $sort = false)
{
    ...
    $link = PLUGIN_RESOURCES_WEBDIR . '/report/professionwithoutcost/professionwithoutcost.php';
    $first = true;
