...
$report_target = PLUGIN_RESOURCES_WEBDIR . '/report/checkhabilitation/checkhabilitation.php';

$report = new AutoReport(__("Report listing the permissions not present in the user's groups", "resources"));
