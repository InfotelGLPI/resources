...
$report_target = PLUGIN_RESOURCES_WEBDIR . '/report/professionwithoutvolume/professionwithoutvolume.php';
...
function showTitle($output_type, &$num, $title, $columnname, $sort = false)
{
    ...
    $link = PLUGIN_RESOURCES_WEBDIR . '/report/professionwithoutvolume/professionwithoutvolume.php';
    $first = true;
